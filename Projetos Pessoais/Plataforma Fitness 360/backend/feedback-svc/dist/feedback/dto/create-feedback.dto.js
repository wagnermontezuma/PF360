...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID do usuário que está enviando o feedback' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], CreateFeedbackDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Título do feedback' }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Conteúdo do feedback' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Categoria do feedback', required: false }),
